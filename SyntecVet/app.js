...
function iconMarkup(name) {
  const icons = {
    ...
    whatsapp: `<svg viewBox="0 0 24 24"><path d="M20.5 11.7a8.5 8.5 0 0 1-12.6 7.4L3 20.5l1.4-4.7a8.5 8.5 0 1 1 16.1-4.1Z"/><path d="M8.1 7.8c.2-.4.4-.4.7-.4h.5c.2 0 .4.1.5.4l.8 1.9c.1.3.1.5-.1.7l-.6.8c-.2.2-.1.4 0 .6.7 1.2 1.7 2.1 2.9 2.7.2.1.4.1.6-.1l.8-1c.2-.2.4-.3.7-.2l1.9.9c.3.1.4.3.4.6v.5c0 .4-.2.8-.5 1-1 .7-2.3.8-3.4.4-1.5-.5-3.1-1.5-4.5-2.8-1.3-1.3-2.3-2.8-2.8-4.2-.4-1-.3-1.9.1-2.8Z"/></svg>`,
